      ...
      <div style="text-align: left">
        <el-dialog
          ...
          <div style="margin-top: 10px">
            <span>菜单名称</span>
            <el-input size="mini" style="width: 200px;" v-model="depName" placeholder="请输入菜单名称..." @keyup.enter.native="addDep"></el-input>
          </div>
...
<script>
  export default {
    ...
    methods: {
      ...
      loadTreeData(){
        var _this = this;
        this.getRequest("/sys/basic/menu/-1").then(resp=> {
      ...
      addMenu(){
        ...
        this.treeLoading = true;
        this.postRequest("/sys/basic/menu", {
          name: this.depName,
          parentId: this.pMenu
        }).then(resp=> {
          _this.treeLoading = false;
